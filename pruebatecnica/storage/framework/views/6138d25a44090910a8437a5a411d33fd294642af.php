...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <style>
            ...
            .card__body--img{
                border-radius: 100%;
                box-shadow: 0 4px 8px 0px var(--c-red), 0 6px 20px 0px var(--c-red);
                width: 120px;
                margin: 30px 0;
            }
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <header>
                    <h1>Pokemón Web</h1>
                    <p><b>INSTRUCCIÓNES:</b> Si desea visualizar otro pokemón de click en el botón o en su lugar espere 30 segundos.
                        Si desea más información coloque el cursor sobre la tarjeta del pokemón.</p>
                </header>
        ...
        <section class="flex">
            <div class="card">
                ...
                <div class="card__overlay">
                    <div class="card__overlay--text"></div>
                </div>
            </div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden sm:rounded-lg">
                    <div class="flex items-center">
                        <a href="welcome" class="underline text-gray-900 dark:text-white">Mostrar Pokemón</a>
                    </div>
                </div>
                ...
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden sm:rounded-lg">
                    <div class="flex items-center">
                        <a href="pokemon" class="underline text-gray-900 dark:text-white">Mostrar Pokemon Guardados</a>
                    </div>
                </div>

                    <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                        Name: Sánchez Salazar Paulina
                    </div>
                </div>
            </div>
        </div>
        ...
        <script>
            ...
            const info = async () => {
                try{
                    ...
                    document.querySelector(".card__overlay--text").innerHTML = 
                        ...
                        guardarBD(id, pokemon.name, pokemon.stats[1].base_stat, pokemon.stats[2].base_stat);
                }catch (e) {
                    console.log(e);
            ...
            setInterval(info, 30000);
             ...
             //guardar registro
             const guardarBD = (id, name, ataque, defensa) => {  
                const obj = [`${id}`,`${name}`,`${ataque}`,`${defensa}`]
                //  try{
                //     const r = await fetch("http://localhost/laravel/pruebatecnica/resources/views/create.php",{
                //     method : "POST",
                ...
                xhttp.open("POST", "http://localhost/laravel/pruebatecnica/resources/views/create.php");
                xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                xhttp.send(`id=${id}&nombre=${name}&ataque=${ataque}&defensa=${defensa}`);
            }
        </script>
    </body>
</html>
<?php /**PATH C:\xampp\htdocs\laravel\pruebatecnica\resources\views/welcome.blade.php ENDPATH**/ ?>