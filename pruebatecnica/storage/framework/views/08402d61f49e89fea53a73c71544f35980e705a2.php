            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden sm:rounded-lg">
                    <div class="flex items-center">
                        <a href="welcome" class="underline text-gray-900 dark:text-white" style="padding: 15px">Regresar</a>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\laravel\pruebatecnica\resources\views/Pokemon/index.blade.php ENDPATH**/ ?>